    ...
    return (
      <Layout location={this.props.location}>
        <main className={this.props.uiState}>
          ...
          <article>
            <h2>Personal</h2>
            <p>His life is complete now that he drives Tesla Model 3;  though his Ducati Monster 797 dearly misses being riden. In his free time he enjoys playing & building games, working out, and developing fantastical ideas.</p>
          </article>
